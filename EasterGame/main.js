...
playerImg.src = "img/krolik.png"; // Path to your player image
...
function update() {
  ...
  } else if(score >= 40 && wave3 == false){
    points = 50;
    blackEggSpawnChance = score * 0.030;
    setTimeout(() => {
      wave3 = true;
      blackEggSpawnChance = score * 0.0021;
    }, 3000)
  }
}
